...
class SydneyFragment : Fragment(), SydneyContract.View{

    private lateinit var presenter: SydneyPresenter
    ...
    private fun init() {
        ...
        presenter = SydneyPresenter(app.service, this)
    ...
    override fun success(model: GeneralModel) {
        tvCity!!.text = model.name //empty name
